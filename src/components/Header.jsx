    ...
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
      <div>
        ...
        <p className="my-6 text-[15px] text-gray-500">
          ...
          deserunt aspernatur quam corrupti, et corporis consequatur id vitae
          dolores molestiae nostrum, illo facilis dolorem veniam molestias
          voluptatum sed quaerat quidem!
        </p>
        <div>
